...
def generate_launch_description():
    ...
    aubo_world = os.path.join(
        get_package_share_directory("aubo_moveit2"), "worlds", "aubo.world"
    )
    ...
    aubo_description_path = os.path.join(
        get_package_share_directory("aubo_moveit2")
    )
    # ROBOT urdf file path:
    xacro_file = os.path.join(aubo_description_path, "urdf", "aubo.gazebo.xacro")
    ...
    robot_description_semantic_config = load_file("aubo_moveit2", "config/aubo.srdf")
    robot_description_semantic = {
        "robot_description_semantic": robot_description_semantic_config
    }

    # Kinematics.yaml file:
    kinematics_yaml = load_yaml("aubo_moveit2", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("aubo_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "aubo_moveit2", "config/moveit_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("aubo_moveit2"), "config")
    rviz_full_config = os.path.join(rviz_base, "aubo_moveit2.rviz")
    rviz_node_full = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
